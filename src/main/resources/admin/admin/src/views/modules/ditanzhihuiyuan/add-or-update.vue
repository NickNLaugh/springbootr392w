<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="推荐建议" prop="tuijianjianyi">
          <el-input v-model="ruleForm.tuijianjianyi" 
              placeholder="推荐建议" clearable  :readonly="ro.tuijianjianyi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="推荐建议" prop="tuijianjianyi">
              <el-input v-model="ruleForm.tuijianjianyi" 
                placeholder="推荐建议" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="碳排量" prop="tanpailiang">
          <el-input v-model="ruleForm.tanpailiang" 
              placeholder="碳排量" clearable  :readonly="ro.tanpailiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="碳排量" prop="tanpailiang">
              <el-input v-model="ruleForm.tanpailiang" 
                placeholder="碳排量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.leixing = true;
          ...
          if(o=='tuijianjianyi'){
            this.ruleForm.tuijianjianyi = obj[o];
	    this.ro.tuijianjianyi = true;
            continue;
          }
          if(o=='zhuyishixiang'){
	    ...
	    this.ro.zhuyishixiang = true;
          ...
          if(o=='tanpailiang'){
            this.ruleForm.tanpailiang = obj[o];
	    this.ro.tanpailiang = true;
            continue;
          }
          if(o=='jianjie'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `ditanzhihuiyuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.ditanzhihuiyuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
