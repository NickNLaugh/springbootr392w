 ...
 */
public class DitanzhihuiyuanVO  implements Serializable {
	...
	public void setTanpailiang(Float tanpailiang) {
		this.tanpailiang = tanpailiang;
	}
	
	/**
	 * 获取：碳排量
	 */
	public Float getTanpailiang() {
		return tanpailiang;
	}
